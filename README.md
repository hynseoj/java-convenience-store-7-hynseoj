...
- [x] **[출력]** 멤버십 할인 적용 여부를 확인하기 위한 안내 문구를 출력한다.
- [x] **[입력]** 멤버십 할인 적용 여부를 입력 받는다.
    - 사용자가 `Y`를 입력하면 멤버십 할인을 적용하고 `N`을 입력하면 적용하지 않는다.


- [x] **[멤버십 할인]** 멤버십 회원은 프로모션 미적용 금액의 30% 를 할인받는다.
- [x] **[멤버십 할인]** 프로모션 적용 후 남은 금액에 대해 멤버십 할인을 적용한다.
- [x] **[멤버십 할인]** 멤버십 할인의 최대 한도는 8000원이다.


- [x] **[재고 관리]** 고객이 상품을 구매할 때마다, 결제된 수량만큼 해당 상품의 재고에서 차감한다.
- [x] **[재고 관리]** 프로모션 기간 중에는 프로모션 재고를 우선적으로 차감하며, 프로모션 재고가 부족한 경우에는 일반 재고를 사용한다.


- [x] **[영수증]** 영수증 항목은 다음과 같다.
...
- [x] **[출력]** 추가 구매 여부 확인을 위한 안내 문구를 출력한다.
- [x] **[입력]** 추가 구매 여부를 입력 받는다.
